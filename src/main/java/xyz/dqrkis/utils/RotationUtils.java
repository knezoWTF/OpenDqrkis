...
import xyz.dqrkis.utils.rotation.Rotation;
...
public final class RotationUtils {
    ...
    // New methods for smooth rotation to target
    public static boolean isRotating() {
        return false; // Simple implementation - no ongoing rotation
    }

    public static void rotateTo(float yaw, float pitch, Runnable callback) {
        if (mc.player != null) {
