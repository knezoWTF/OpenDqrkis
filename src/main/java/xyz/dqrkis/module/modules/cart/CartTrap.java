...
public final class CartTrap extends Module implements TickListener {
    ...
    private final KeybindSetting activateKey = new KeybindSetting(EncryptedString.of("Activate Key"), 82, false);
    ...
    public CartTrap() {
        super(EncryptedString.of("Cart Trap"), EncryptedString.of("Traps players with cart"), -1, Category.CART);
